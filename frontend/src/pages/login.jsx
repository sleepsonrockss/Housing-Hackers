        ...
        <div className="w-full max-w-[400px]">
          ...
          <div className="mb-8">
            <div className="flex items-center justify-center gap-2 mb-4">
              ...
              <span className="text-[11px] tracking-widest uppercase text-zinc-500">Welcome Back</span>
              <span className="h-px w-6 bg-zinc-700" />
            </div>
            <h1 className="text-3xl font-semibold tracking-tight text-center mb-2">Sign in</h1>
            <p className="text-center text-[13px] text-zinc-500">
              Continue your journey through tenant rights.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 mb-6">
            ...
            <button
              type="submit"
              className="w-full bg-white text-zinc-950 text-[13px] font-semibold py-2.5 rounded-lg hover:bg-zinc-100 transition-all mt-6"
            >
              Sign in
            </button>
          </form>
          ...
          <div className="space-y-2 mb-8">
            <button className="w-full px-4 py-2.5 rounded-lg border border-zinc-800 bg-zinc-900/50 text-[13px] font-medium text-white hover:border-zinc-700 hover:bg-zinc-900 transition-colors flex items-center justify-center gap-2">
